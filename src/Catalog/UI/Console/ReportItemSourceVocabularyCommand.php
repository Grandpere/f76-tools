...
final class ReportItemSourceVocabularyCommand extends Command
{
    ...
    private function resolveMappedFields(string $provider, string $field, string $value): array
    {
        ...
        foreach (['containers', 'random_encounters', 'enemies', 'events', 'expeditions', 'daily_ops', 'raid', 'unused_content', 'seasonal_content', 'treasure_maps', 'quests', 'vendors', 'world_spawns'] as $candidateField) {
