...
- Done (slice 7): alignement du rendu d icones des cartes sur le pattern Minerva (footer inline) et extension prudente de la couverture a `enemies` et `expeditions` via les assets Fallout deja disponibles.
