...
- Conserver une doc ops courte et actionnable (`docs/ops/ops-runbook.md`) pour les commandes d exploitation.
...
- Front catalogue:
  - selection du player actif persiste en localStorage (bucket utilisateur), sans query param dedie dans l URL.
